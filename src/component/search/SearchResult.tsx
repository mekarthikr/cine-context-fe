...
export function SearchResults({ query, isOpen, onClose }: SearchResultsProps) {
          ...
          .map((item: any): SearchResult => {
            if (item.media_type === 'person') {
              ...
              return {
                ...
                overview:
                  content.overview.slice(0, 120) + (content.overview.length > 120 ? '...' : ''),
              };
            }
          });
  ...
  return (
    <div className="absolute top-full left-0 right-0 z-50 mt-2">
      <Card className="bg-slate-800 border-slate-700 shadow-2xl max-h-96 overflow-hidden p-1">
        <CardContent className="p-0">
          {/* Header */}
          <div className="flex items-center justify-between pl-4 pr-4 pb-1 border-b border-slate-700">
