...
export function ContentTitleLogo({
    ...
    const fetchLogo = async () => {
      try {
        ...
        const imagesResponse =
          contentType === "movie" ? await tmdbApi.getMovieImages(contentId) : await tmdbApi.getTVShowImages(contentId)
  ...
  if (loading) {
    return (
      <div className={`animate-pulse bg-slate-700 rounded ${fallbackClassName}`} style={{ height: '120px' }}>
